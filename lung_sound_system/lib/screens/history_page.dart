...
class _HistoryPageState extends State<HistoryPage> {
  ...
  // Fetch only the current user's patients
  Future<void> _fetchPatients() async {
    final currentUser = FirebaseAuth.instance.currentUser;

    if (currentUser == null) return;  // Handle case when user is not logged in

    try {
      QuerySnapshot snapshot = await FirebaseFirestore.instance
          .collection('patients')
          .where('uid', isEqualTo: currentUser.uid) // Fetch patients for the logged-in user
          .get();
